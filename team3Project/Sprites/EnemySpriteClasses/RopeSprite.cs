...
public class RopeSprite
{
    public class RopeSprite : IEnemySprite
    {
        ...
        public RopeSprite(Texture2D texture, string direction)
        {
            state = new DownMovingRopeState(this);
            spriteSheet = texture;
            currentFrame = 0;
        }
        ...
        public void moveLeft()
        {
            ...
            if (destinationRectangle.X <= 0)
            {
                ...
                state = new RightMovingRopeState(this);
            }
        }
        ...
        public void moveDown()
        {
            ...
            if (destinationRectangle.Y >= 480)
            {
                ...
                state = new UpMovingRopeState(this);
            }
        }
