namespace LoZClone
{
    ...
    public class EnemySpriteFactory
    {
        ...
        private readonly SpriteSheetData downDodongoData = new SpriteSheetData("dodongoDown", 30, 35, 1, 3);
        private Texture2D upDodongo;
        private readonly SpriteSheetData upDodongoData = new SpriteSheetData("dodongoUp", 30, 35, 1, 3);
        private Texture2D leftDodongo;
        private readonly SpriteSheetData leftDodongoData = new SpriteSheetData("dodongoLeft", 40, 30, 1, 3);
        private Texture2D rightDodongo;
        private readonly SpriteSheetData rightDodongoData = new SpriteSheetData("dodongoRight", 40, 30, 1, 3);
