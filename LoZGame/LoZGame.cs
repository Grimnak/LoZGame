namespace LoZClone
{
    ...
    public class LoZGame : Game
    {
        ...
        public static readonly int StartDungeon = 4; // dungeon ID to load into [1 - 5];
        public int Difficulty = -3; // 0 is normal, can scale infinitely up but you'll get really dumb bugs and probably crash
