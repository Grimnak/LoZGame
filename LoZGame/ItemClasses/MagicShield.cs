namespace LoZClone
{
    ...
    internal class MagicShield : IItem
    {
        ...
        public MagicShield(Vector2 loc)
        {
            this.sprite = ItemSpriteFactory.Instance.MagicShield(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.ShieldWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.ShieldHeight * ItemSpriteFactory.Instance.Scale);
