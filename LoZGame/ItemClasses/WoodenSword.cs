namespace LoZClone
{
    ...
    internal class WoodenSword : IItem
    {
        ...
        private int pickUpItemTime = 200;
        ...
        public WoodenSword(Vector2 loc)
        {
            this.sprite = ItemSpriteFactory.Instance.WoodenSword(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.SwordWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.SwordHeight * ItemSpriteFactory.Instance.Scale);
