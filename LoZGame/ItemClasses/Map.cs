namespace LoZClone
{
    ...
    internal class Map : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.Map(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.MapWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.MapHeight * ItemSpriteFactory.Instance.Scale);
