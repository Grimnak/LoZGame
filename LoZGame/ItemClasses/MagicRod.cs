namespace LoZClone
{
    ...
    internal class MagicRod : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.MagicRod(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.MagicRodWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.MagicRodHeight * ItemSpriteFactory.Instance.Scale);
