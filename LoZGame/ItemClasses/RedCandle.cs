namespace LoZClone
{
    ...
    internal class RedCandle : IItem
    {
        ...
        public RedCandle(Vector2 loc)
        {
            this.sprite = ItemSpriteFactory.Instance.RedCandle(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.CandleWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.CandleHeight * ItemSpriteFactory.Instance.Scale);
