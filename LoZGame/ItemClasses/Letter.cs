namespace LoZClone
{
    ...
    internal class Letter : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.Letter(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.LetterWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.LetterHeight * ItemSpriteFactory.Instance.Scale);
