namespace LoZClone
{
    ...
    internal class Raft : IItem
    {
        ...
        public Raft(Vector2 loc)
        {
            this.sprite = ItemSpriteFactory.Instance.Raft(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.RaftWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.RaftHeight * ItemSpriteFactory.Instance.Scale);
