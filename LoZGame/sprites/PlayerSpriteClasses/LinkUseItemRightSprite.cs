namespace LoZClone
{
    ...
    public class LinkUseItemRightSprite : SpriteEssentials, ISprite
    {
        ...
        private readonly int frameDelayMax = 15;

        public LinkUseItemRightSprite(Texture2D spriteTexture, SpriteData data)
        {
