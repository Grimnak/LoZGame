namespace LoZClone
{
    ...
    public class BombedOpeningRightSprite : ISprite
    {
        ...
        public BombedOpeningRightSprite(Texture2D spriteTexture, Vector2 loc, SpriteSheetData data)
        {
        ...
        public void Draw(Vector2 location, Color spriteTint)
        {
            ...
            Rectangle destinationRectangle = new Rectangle((int)this.Location.X, (int)this.Location.Y, this.spriteWidth, this.spriteHeight * 2);
