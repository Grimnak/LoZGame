namespace LoZClone
{
    ...
    public class UnlockedDoorDownSprite : ISprite
    {
        ...
        public UnlockedDoorDownSprite(Texture2D spriteTexture, Vector2 loc, SpriteSheetData data)
        {
        ...
        public void Draw(Vector2 location, Color spriteTint)
        {
            ...
            Rectangle destinationRectangle = new Rectangle((int)this.Location.X, (int)this.Location.Y, this.spriteWidth * 2, (int)(this.spriteHeight * 1.5));
