namespace LoZClone
{
    ...
    public class VerticalBricksSprite : ISprite
    {
        ...
        public VerticalBricksSprite(Texture2D spriteTexture, Vector2 loc, SpriteSheetData data)
        {
        ...
        public void Draw(Vector2 location, Color spriteTint)
        {
            ...
            LoZGame.Instance.SpriteBatch.Draw(this.spriteSheet, this.Location, sourceRectangle, spriteTint, 0f, new Vector2(0, 0), 1.0f, SpriteEffects.None, 0.0f);
        }
    }
}