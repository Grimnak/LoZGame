        ...
        public UnlockedDoorState(Door door)
        {
            ...
            switch (door.GetLoc())
            {
                case "N":
                {
                    ...
                    door.Bounds = new Rectangle((int)door.Physics.Location.X, (int)door.Physics.Location.Y, 70, BlockSpriteFactory.Instance.VerticalOffset + 1);
                    break;
                }
                case "E":
                {
                        ...
                        door.Physics = new Physics(location, new Vector2(0, 0), new Vector2(0, 0));
                        door.Bounds = new Rectangle((int)door.Physics.Location.X, (int)door.Physics.Location.Y, BlockSpriteFactory.Instance.HorizontalOffset - 1, 70);
                        break;
                }
                case "S":
                {
