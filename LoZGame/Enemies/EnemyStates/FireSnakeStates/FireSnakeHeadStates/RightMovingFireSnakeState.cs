namespace LoZClone
{
    ...
    public class RightMovingFireSnakeState : IEnemyState
    {
        ...
        public RightMovingFireSnakeState(IEnemy fireSnake)
        {
            ...
            this.fireSnake.Physics.MovementVelocity = new Vector2(this.fireSnake.MoveSpeed, 0);
        }
