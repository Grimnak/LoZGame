namespace LoZClone
{
    ...
    public class UpLeftMovingFireSnakeState : IEnemyState
    {
        ...
        public UpLeftMovingFireSnakeState(IEnemy fireSnake)
        {
            ...
            this.fireSnake.Physics.MovementVelocity = new Vector2(-1 * this.fireSnake.MoveSpeed, -1 * this.fireSnake.MoveSpeed);
