namespace LoZClone
{
    ...
    public class UpMovingFireSnakeState : IEnemyState
    {
        ...
        public UpMovingFireSnakeState(IEnemy fireSnake)
        {
            ...
            this.fireSnake.Physics.MovementVelocity = new Vector2(0, -1 * this.fireSnake.MoveSpeed);
        }
