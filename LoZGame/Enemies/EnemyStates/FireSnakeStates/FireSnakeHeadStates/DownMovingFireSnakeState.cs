namespace LoZClone
{
    ...
    public class DownMovingFireSnakeState : IEnemyState
    {
        ...
        public DownMovingFireSnakeState(IEnemy fireSnake)
        {
            ...
            this.fireSnake.Physics.MovementVelocity = new Vector2(0, this.fireSnake.MoveSpeed);
        }
