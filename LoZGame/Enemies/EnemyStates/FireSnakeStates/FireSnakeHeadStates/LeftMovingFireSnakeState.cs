namespace LoZClone
{
    ...
    public class LeftMovingFireSnakeState : IEnemyState
    {
        ...
        public LeftMovingFireSnakeState(IEnemy fireSnake)
        {
            ...
            this.fireSnake.Physics.MovementVelocity = new Vector2(-1 * this.fireSnake.MoveSpeed, 0);
        }
