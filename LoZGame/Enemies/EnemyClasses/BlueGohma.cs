namespace LoZClone
{
    ...
    public class BlueGohma : EnemyEssentials, IEnemy
    {
        public BlueGohma(Vector2 location)
        {
            RandomStateGenerator = new RandomStateGenerator(this);
            States = new Dictionary<RandomStateGenerator.StateType, int>(GameData.Instance.EnemyStateWeights.GohmaStateList);
            Health = new HealthManager(GameData.Instance.EnemyHealthConstants.BlueGohmaHealth);
        ...
        public override ISprite CreateCorrectSprite()
        {
            ...
            {
                return EnemySpriteFactory.Instance.CreateBlueGohmaOpenEye();
            }
            else
            {
                return EnemySpriteFactory.Instance.CreateBlueGohmaClosedEye();
            }
        }
    }
}
