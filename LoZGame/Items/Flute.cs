namespace LoZClone
{
    ...
    internal class Flute : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.Flute(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc);
            this.Size = new Vector2(ItemSpriteFactory.FluteWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.FluteHeight * ItemSpriteFactory.Instance.Scale);
