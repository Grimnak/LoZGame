namespace LoZClone
{
    ...
    internal class MagicKey : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.MagicKey(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc);
            this.Size = new Vector2(ItemSpriteFactory.KeyWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.KeyHeight * ItemSpriteFactory.Instance.Scale);
