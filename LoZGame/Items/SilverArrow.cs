namespace LoZClone
{
    ...
    internal class SilverArrow : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.SilverArrow(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.ArrowWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.ArrowHeight * ItemSpriteFactory.Instance.Scale);
