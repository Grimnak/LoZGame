namespace LoZClone
{
    ...
    internal class WhiteSword : ItemEssentials, IItem
    {
        public WhiteSword(Vector2 loc)
        {
            Sprite = ItemSpriteFactory.Instance.WhiteSword();
            itemCollisionHandler = new ItemCollisionHandler(this);
            Physics = new Physics(loc);
            PickUpItemTime = LoZGame.Instance.UpdateSpeed;
            LifeTime = 0;
            Vector2 size = new Vector2(ItemSpriteFactory.SwordWidth, ItemSpriteFactory.SwordHeight);
