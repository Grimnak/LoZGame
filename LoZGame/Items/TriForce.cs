namespace LoZClone
{
    ...
    internal class Triforce : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.Triforce(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc);
            this.Size = new Vector2(ItemSpriteFactory.TriforceWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.TriforceHeight * ItemSpriteFactory.Instance.Scale);
