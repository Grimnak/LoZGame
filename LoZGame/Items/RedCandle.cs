namespace LoZClone
{
    ...
    internal class RedCandle : ItemEssentials, IItem
    {
        public RedCandle(Vector2 loc)
        {
            Sprite = ItemSpriteFactory.Instance.RedCandle();
            itemCollisionHandler = new ItemCollisionHandler(this);
            Physics = new Physics(loc);
            PickUpItemTime = LoZGame.Instance.UpdateSpeed;
            LifeTime = 0;
            Vector2 size = new Vector2(ItemSpriteFactory.CandleWidth, ItemSpriteFactory.CandleHeight);
