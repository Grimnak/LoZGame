namespace LoZClone
{
    ...
    internal class PowerBracelet : IItem
    {
        ...
        {
            this.sprite = ItemSpriteFactory.Instance.PowerBracelet(ItemSpriteFactory.Instance.Scale);
            this.itemCollisionHandler = new ItemCollisionHandler(this);
            this.Physics = new Physics(loc, new Vector2(0, -1), new Vector2(0, 0.1f));
            this.Size = new Vector2(ItemSpriteFactory.PowerBraceletWidth * ItemSpriteFactory.Instance.Scale, ItemSpriteFactory.PowerBraceletHeight * ItemSpriteFactory.Instance.Scale);
